...
from linformer import LinformerMultiHeadAttention, LinformerFasterMultiHeadAttention
from nystromformer import NystromformerAttention
...
class Block(nn.Module):
    ...
    def __init__(self, config):
        ...
        elif attention_type == "standard": # standard
